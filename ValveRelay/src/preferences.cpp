...
const uint16_t getRelayPin() { return prefs.relayPin; };
...
const char *getMqttControlTopic() { return prefs.mqttControlTopic.c_str(); };
...
void readSensor() {
    ...
    if (preferences.begin("valveRelay")) {
        ...
        prefs.relayPin = preferences.getUShort("relayPin");
        ...
        prefs.mqttControlTopic = preferences.getString("mqttCtrlTopic");
    ...
    log_d("mqttControlTopic=%s", getMqttControlTopic());
}
